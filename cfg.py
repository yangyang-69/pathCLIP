...
# element_model=r'output/element_model_josh.pth'
element_model=r'output/element_model_original.pth'
...
# OCR configurations
test_home_folder = r'/home/fei/Desktop/weiwei/data/use_case/result/'  # home folder
