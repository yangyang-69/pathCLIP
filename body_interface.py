...
def build_data_fold_loader(cfg, data_folder, mapper=None):
    ...
    Returns:
        ...
        dataset, with result-time transformation and batching.
    """
...
def predict(cfg_file_path,entity_type,data_folder):
    ...
    if entity_type!= 'rotated_relation':
        ...
        # evaluation_res = RegularTrainer.result(config, model,
...
#                     # cv2.imwrite('/mnt/detectron2/pathway_retinanet_weiwei_65k/result/crop_ok.jpg', crop_img)
...
#
#     # data_folder = r'/home/fei/Desktop/weiwei/data/use_case/result/0/'
#     # ocr_sub_img_folder=r'/home/fei/Desktop/weiwei/data/use_case/result/ocr_sub_img/pdf_170_Targeting_2_10/'
#     data_folder = os.path.join(kwargs['dataset'], 'img/')
...
if __name__ == "__main__":
    ...
    # args.outputpath = r'/home/fei/Desktop/result/results/'
    ...
    img_path = os.path.join(file_path, 'test/img/img/')
