...
def collect_files(img_dir, gt_dir, split_info):
    ...
    Args:
        ...
        split_info (dict): The split information for train/val/result
...
def generate_ann(root_path, split, image_infos, preserve_vertical, format):
    ...
    Args:
        ...
        split (str): The split of dataset. Namely: training or result
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Generate training, val, and result set of NAF ')
...
def main():
    ...
    for split in ['training', 'val', 'result']:
