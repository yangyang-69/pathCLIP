...
def parse_args():
    parser = argparse.ArgumentParser(
        description='MMOCR result (and eval) a model.')
    ...
    parser.add_argument(
        ...
        'submit them to the result server.')
    parser.add_argument(
        '--eval',
        type=str,
        nargs='+',
...
def main():
    ...
    # in case the result dataset is concatenated
    ...
    default_loader_cfg.update({
        ...
        for k, v in cfg.data.items() if k not in [
            'train', 'val', 'result', 'train_dataloader', 'val_dataloader',
            'test_dataloader'
        ]
    })
    test_loader_cfg = {
